 ...
 * 
 * Return a single integer X mod 10003, here X is number of Amazing Substrings
 * in given string. Constraints
 * 
 ...
 * Output 6
 * 
 * Explanation Amazing substrings of given string are : 1. A 2. AB 3. ABE 4.
 * ABEC 5. E 6. EC here number of substrings are 6 and 6 % 10003 = 6.
 * 
 * @author kaussark
 *
 */
public class Problem56 {
	...
	private boolean isVowel(char cha) {
		return Character.toLowerCase(cha) == 'a'
				|| Character.toLowerCase(cha) == 'e'
				|| Character.toLowerCase(cha) == 'u'
				|| Character.toLowerCase(cha) == 'i'
				|| Character.toLowerCase(cha) == 'o';
