 ...
 * than 4, answer = 4. Input:
 * 
 * A : list of positions of mice B : list of positions of holes Output:
 * 
 * single integer value NOTE: The final answer will fit in a 32 bit signed
 * integer.
 * 
 * @author kaussark
 *
...
public class Problem229 {
	...
	public int mice(ArrayList<Integer> A, ArrayList<Integer> B) {
		...
		for(int index = 0; index < A.size(); index++) {
			maxSteps = Math.max(Math.abs(A.get(index)-B.get(index)), maxSteps);
		}
        return maxSteps;
    }
